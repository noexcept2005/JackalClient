...
template<typename T>
struct DetoursIsFunctionPointer : false_type {};

template<typename T>
struct DetoursIsFunctionPointer<T*> : is_function<typename remove_pointer<T>::type> {};

template<
    typename T,
    typename enable_if<DetoursIsFunctionPointer<T>::value, int>::type = 0>
