...
unordered_map<ModuleID, pair<string, string>> module_descriptions
{
	...
	{ AntiProcCreate, {"Prevents new processes from being created using a driver.", "使用驱动程序阻止新进程的创建。"}},
	{ Elevator, {"Elevate a process without restarting it using a driver.", "使用驱动程序提升进程权限，无需重启它。"}},
	{ ForceTerminator, {"Helps you terminate target processes forcibly using a driver.", "使用驱动程序帮你强制终止目标进程。"}},
	...
	{ Minecraft, {"Display Minecraft HUD elements.", "显示 Minecraft 的 HUD 元素。"}},
	...
	{ IRC, {"A simple online chat system.", "一个简单的在线聊天系统。"}},
	{ AntiWebpage, {"Automatically close bad webpages.", "自动关闭不好的网页。"}},
	{ AutoLiveChatter, {"Automatically send live chatter messages.", "自动发送直播间弹幕消息。"}},
	...
	{ DisableIMC, {"Disable global Input Method once.", "单次禁用全局输入法。" } },
	{ NoIMC, {"Keep disabling global Input Method.", "保持禁用全局输入法。" }},
